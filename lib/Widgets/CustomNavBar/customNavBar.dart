...
class _CustomNavBarState extends State<CustomNavBar> {
  ...
  Widget build(BuildContext context) {
    return Consumer3<AuthController, DashboardController, SearchBarController>(
        builder: (context, authController, dashboardProvider, searchBarProvider,
            child) {
      return Container(
            ...
            BottomNavigationBarItem(
                icon: SizedBox(
                    ...
                    child: StreamBuilder<int?>(
                        stream: SharedPreferencesService()
                            .getInt('cart_items_count')
                            .asStream(),
