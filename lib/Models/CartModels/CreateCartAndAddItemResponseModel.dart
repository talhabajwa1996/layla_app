class CreateCartAndAddItemResponseModel {
  CartCreate? cartCreate;

  CreateCartAndAddItemResponseModel({this.cartCreate});

  CreateCartAndAddItemResponseModel.fromJson(Map<String, dynamic> json) {
    cartCreate = json['cartCreate'] != null
        ? new CartCreate.fromJson(json['cartCreate'])
        : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.cartCreate != null) {
      data['cartCreate'] = this.cartCreate!.toJson();
    }
    return data;
  }
}
...
class CartCreate {
  ...
  CartCreate({this.cart, this.userErrors});
